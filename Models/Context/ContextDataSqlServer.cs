...
public class ContextDataSqlServer : IdentityDbContext<Usuario>, IContextData
{
    ...
    public void CadastrarCliente(Cliente cliente)
    {
        try
        {
            ...
            command.Parameters.Add("@id", SqlDbType.VarChar).Value =
                cliente.Id; //seta valor para o parâmetro "@id" no comando SQL
    ...
    public List<Cliente> ListarCliente()
    {
        ...
        try
        {
            ...
            foreach (DataRow item in rows)
            {
                ...
                {
                    Id = id, Nome = nome, Telefone = telefone, Cpf = cpf, Email = email,
                    IdStatusCliente = idStatusCliente, Status = (StatusCliente)idStatusCliente
                };
    ...
    public Cliente ObterClientePorId(string id)
    {
        ...
        try
        {
            ...
            foreach (DataRow item in rows)
            {
                ...
                cliente = new Cliente
                {
                    Id = codigo, Nome = nome, Telefone = telefone, Cpf = cpf, Email = email,
                    IdStatusCliente = idStatusCliente, Status = (StatusCliente)idStatusCliente
                };
            }
    ...
    public void ExcluirCliente(string id)
    {
        try
        {
            ...
            command.Parameters.Add("@id", SqlDbType.VarChar).Value =
                id; //seta valor para o parâmetro "@id" no comando SQL
            command.ExecuteNonQuery();
        }
        catch (Exception e)
        {
